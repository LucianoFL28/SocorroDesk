...
public class UsuarioVO {
	...
	public void imprimir() {
		System.out.printf("\n%3s  %-13s  %-20s  %-11s  %-20s  %-15s  %-15s  %-10s  %-10s  "
				, this.getIdUsuario(), this.getTipoUsuarioVO(), this.getNome(), this.getCpf()
				, this.getEmail(), this.validarData(this.getDataCadastro()), this.validarData(this.getDataExpiracao()), this.getLogin(), this.getSenha());
